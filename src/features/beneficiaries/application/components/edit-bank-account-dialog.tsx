  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>{t("beneficiaries.bank_accounts.edit_dialog.title")}</DialogTitle>
          <DialogDescription>
            {t("beneficiaries.bank_accounts.edit_dialog.description")}
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="flex gap-6">
            ...
            >
              {t("beneficiaries.bank_accounts.edit_dialog.cancel")}
            </Button>
            <Button type="submit" variant="default" size="default">
              {t("beneficiaries.bank_accounts.edit_dialog.submit")}
            </Button>
          </div>
        </form>
      </DialogContent>
